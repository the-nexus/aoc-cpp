...
namespace AOC::Tools
{
    ...
    {
    public:
        static inline void SplitString(std::string const& stringToSplit, char const delimiter, std::vector<std::string>& outSubstrings)
        {
            SplitString<char>(stringToSplit, delimiter, 1, outSubstrings);
        }

        static inline void SplitString(std::string const& stringToSplit, std::string const& delimiter, std::vector<std::string>& outSubstrings)
        {
    ...
    private:
        template <typename T>
        static void SplitString(std::string const& stringToSplit, T const& delimiter, size_t const delimiterSize, std::vector<std::string>& outSubstrings)
        {
