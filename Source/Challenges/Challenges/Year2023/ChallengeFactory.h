...
namespace AOC::Challenges::Year2023
{
    std::unique_ptr<ChallengeAbstract> MakeChallenge(int const day, std::vector<std::string> const& inputLines)
    {
        ...
        //case 20: return std::make_unique<Challenge20>(inputLines);
        //case 21: return std::make_unique<Challenge21>(inputLines);
        //case 22: return std::make_unique<Challenge22>(inputLines);
        //case 23: return std::make_unique<Challenge23>(inputLines);
        //case 24: return std::make_unique<Challenge24>(inputLines);
        //case 25: return std::make_unique<Challenge25>(inputLines);
