...
namespace aoc::core
{
    ...
    {
    public:
        static void SplitString(std::string const& stringToSplit, char const delimiter, std::vector<std::string>& outSubstrings)
        {
            SplitString<char>(stringToSplit, delimiter, 1, outSubstrings);
        }

        static void SplitString(std::string const& stringToSplit, std::string const& delimiter, std::vector<std::string>& outSubstrings)
        {
